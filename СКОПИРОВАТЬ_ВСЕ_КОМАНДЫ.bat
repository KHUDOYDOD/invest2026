...
echo ========================================
echo 📋 КОПИРОВАНИЕ КОМАНД В БУФЕР ОБМЕНА
echo ========================================

(
echo # АВТОМАТИЧЕСКАЯ УСТАНОВКА INVESTPRO НА VPS 213.171.31.215
echo # Выполните эти команды в веб-консоли VPS
echo.
...
echo.
echo # 3. Установка PM2, Nginx, Git
...
echo echo "Установка завершена! Сайт доступен: http://213.171.31.215"
) | clip

echo ✅ ВСЕ КОМАНДЫ СКОПИРОВАНЫ В БУФЕР ОБМЕНА!
echo.
echo Теперь:
echo 1. Откройте веб-консоль VPS в браузере
echo 2. Войдите как root11 с паролем: $X11021997x$
echo 3. Вставьте команды (Ctrl+V или правой кнопкой мыши)
echo 4. Нажмите Enter для выполнения
echo.
